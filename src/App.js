...
const UserPoolId = 'ap-southeast-1_0FRkOCWgE';
const ClientId = '7rrei7uj8b2vct0tjani114ori';
const ApiGatewayUrl = 'https://9hb8me7f48.execute-api.ap-southeast-1.amazonaws.com/TestingAPI';
  ...
  onSubmit = (event) => {
    ...
    cognitoUser.authenticateUser(authenticationDetails, {
        ...
        newPasswordRequired: (userAttributes, requiredAttributes) => {
          ...
          userAttributes['email'] = 'sanjeev.kumar@gmail.com';
